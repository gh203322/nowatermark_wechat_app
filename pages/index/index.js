...
Page({
  ...
  oSubmit: function () {
    ...
    this.replaceReg(a.data.defaultUrl), '' != a.data.videoUrl && a.regUrl(a.data.videoUrl) ? (wx.showLoading({
      ...
      success: function (t) {
        wx.hideLoading(), t.data ? (a.showToast('解析成功', 'success'), wx.setStorageSync('dataUrl', t), 
          app.globalData.videoSrc = t.data, app.globalData.videoUrl = a.data.videoUrl,
          wx.navigateTo({
